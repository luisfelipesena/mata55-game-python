"""
    ...
    Olhar link: https://pythonprogramming.org/making-pongpong-game-development-using-pyglet-part-1/
"""
...
class Window(pyglet.window.Window):
    def __init__(self, *args, **kwargs):
        ...
        super(Window, self).__init__(width=DIM[0], height=DIM[1], *args, **kwargs)
        # ------------------ MVC --------------------#
        the_window = self
